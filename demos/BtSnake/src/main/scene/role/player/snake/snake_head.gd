...
const body_scene  := preload("res://src/main/scene/role/player/snake/snake_body.tscn") as PackedScene
const joint_scene := preload("res://src/main/scene/role/player/snake/snake_joint.tscn") as PackedScene
