...
var b_red = preload("res://src/main/assets/texture/health/hp_red.png")
var b_green = preload("res://src/main/assets/texture/health/hp_green.png")
var b_yellow = preload("res://src/main/assets/texture/health/hp_yellow.png")
